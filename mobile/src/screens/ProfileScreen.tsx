...
export function ProfileScreen() {
  ...
  const confirmApiChange = () => {
    ...
    Alert.alert("API sunucusunu değiştir", "Yeni sunucu hesabındaki verilere erişecek. Adresi doğrulayıp kaydetmek istediğine emin misin?", [
  ...
  const closeMeasurementEditor = () => {
    ...
    Alert.alert("Değişiklikler kaydedilsin mi?", "Ölçülerinde yaptığın değişiklikleri kaydetmeden çıkabilirsin.", [
      { text: "Kaydetmeden çık", style: "destructive", onPress: () => {
        dirtyRef.current = false;
    ...
    >
      ...
      <Card style={styles.formCard}>
        ...
        <Button
          ...
          tone="blue"
        />
        {session.profile ? <Button label="Düzenlemeden çık" onPress={closeMeasurementEditor} tone="light" /> : null}
      </Card>
      )}
        ...
        {settingsOpen ? (
          <View style={styles.settingsBody}>
            ...
            <View style={styles.serverCard}>
              ...
              <Field autoCapitalize="none" autoCorrect={false} hint="Beta ve üretim sunucusu: https://fitmemory-api.onrender.com" keyboardType="url" label="Adres" onChangeText={setApiUrl} value={apiUrl} />
      ...
      <Card style={styles.security}>
        ...
        <View style={styles.securityCopy}>
          ...
          <Text style={styles.securityText}>FitMemory bağımsız bir platformdur. Uygulama içerisinde yer alan 3. taraf markalar ve logolar ilgili şirketlerin kendi tescilli mülkiyetindedir ve yalnızca yönlendirme (navigasyon) amacıyla kullanılmıştır. FitMemory'nin bu markalarla resmi bir bağı bulunmamaktadır.</Text>
        </View>
      </Card>
      <View style={styles.footerBrand}>
        <Brand compact />
        <Text style={styles.version}>Mobil · 1.25.27</Text>
      </View>
    </ScrollView>
  );
}
