...
const english: Record<string, string> = {
  ...
  "Kaydedildi · Dolabım Kaydedilenler": "Saved · Closet Saved",
  "Bu kombin dolabındaki parçalardan kurulur ve Dolabım → Kaydedilenler’e gider.": "This outfit is built from your closet and goes to Closet → Saved.",
  ...
  "Dolabım → Kaydedilenler’e eklendi.": "Added to Closet → Saved.",
  "Henüz dolap kombini yok": "No closet outfits yet",
