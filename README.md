...
├── mobile-expo-go/           Expo Go istemcisi (1.25.17)
├── migration/
...
Kullandığınız istemci Expo Go ise `mobile-expo-go` (sürüm **1.25.17**):
...
açmanız gerekmez. Profil **Mobil · 1.25.17** görünmelidir.
