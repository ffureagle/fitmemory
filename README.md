...
├── mobile-expo-go/           Expo Go istemcisi (1.25.27)
├── migration/
...
Kullandığınız istemci Expo Go ise `mobile-expo-go` (sürüm **1.25.27**):
...
açmanız gerekmez. Profil **Mobil · 1.25.27** görünmelidir.
