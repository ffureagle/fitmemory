...
├── mobile-expo-go/           Expo Go istemcisi (1.25.28)
├── migration/
...
Kullandığınız istemci Expo Go ise `mobile-expo-go` (sürüm **1.25.28**):
...
açmanız gerekmez. Profil **Mobil · 1.25.28** görünmelidir.
