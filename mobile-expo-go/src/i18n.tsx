...
const english: Record<string, string> = {
  ...
  "Ölçüleri santimetre olarak gir. Omuz genişliği tek taraftan diğer tarafa; göğüs ve bel ise çevre ölçüsüdür.": "Enter measurements in centimetres. Shoulder width is measured across; chest and waist are circumferences.",
