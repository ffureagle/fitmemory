  ...
  return {
    ...
    profile: input.profile
      ? {
          ...
          hipCircumferenceCm: input.profile.hipCircumferenceCm,
          frontWaistCm: input.profile.frontWaistCm,
          inseamCm: input.profile.inseamCm,
          backWaistCm: input.profile.backWaistCm,
